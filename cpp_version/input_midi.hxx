...
class input_params_midi : public input_params_base, public midi_event, private midi_codes {
 public:
  explicit input_params_midi(const bool&);
...
class input_params_midi_pckeyboard : public input_params_midi{
 ...
 public:
  ...
  explicit input_params_midi_pckeyboard(istream&i_str);
  unsigned long check_next_time_stamp(void);
  bool eot(void) const;
  bool is_ready(void);
};
...
class input_params_midi_pckeyboard_file : public input_params_midi_pckeyboard{
 ...
 public:
  // relevant connection parameter here
  explicit input_params_midi_pckeyboard_file(const string&);
  ~input_params_midi_pckeyboard_file(void);
};
