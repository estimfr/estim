...
for start_val in range(0, 2):
    ...
    print("------------------------------------------------------------------------")
    print("shifts\tarc tg\t\tangle\t\t\tnormalised 0..2.pi angle -> 0.00..1.00\t\t\tcumulative\tcumul")
    if start_val == 0:
        title_c_p_h = "=0.5+0.625+0.03125+"
    else:
        title_c_p_h = "=0.5+0.25+0.0625+"
    ...
    for ind in a:
        ...
        if start_val == 0:
            cumul_pseudo_hex = "{:.12f}".format(cumul_cos - 0.5 - 0.0625 - 0.03125)
        else:
            cumul_pseudo_hex = "{:.12f}".format(cumul_cos - 0.5 - 0.25 - 0.0625)
        ...
        print("{:.12f}".format(1 / cumul_cos) + "\t" + cumul_pseudo_hex)

    print("C plus plus list")
    print("replace [] by {}")
    print(list_16)
    print(list_24)
    print(list_32)
